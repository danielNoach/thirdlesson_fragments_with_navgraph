    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Regbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("passworduser",Password.getText().toString());
                Navigation.findNavController(view).navigate(R.id.action_blankFragmentHome_to_blankFragmentreg, bundle);
            }
        });
        ...
        Logbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_blankFragmentHome_to_blankFragmentlog);
            }
        });
